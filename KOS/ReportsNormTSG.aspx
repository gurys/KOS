<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportsNormTSG.aspx.cs" Inherits="KOS.ReportsNormTSG" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Отчеты по событиям с превышением нормативного времени</title>
    <style type="text/css">
    ...
    <form id="form1" runat="server" style ="background-color:#ede8e8; font-family:'Segoe UI', Verdana, Helvetica, Sans-Serif; font-size: 13px;">
       ...
       &nbsp;в excel&nbsp;<asp:ImageButton ID="Excel" runat="server" OnClick="Excel_Click" AlternateText="excel" ImageUrl="~/Images/excel50.png" Width="30" />
        <asp:HyperLink ID="Download" runat="server" Visible="true"></asp:HyperLink>
            ...
            <br />
            <br />
            &nbsp;эл.снабжение/аврия-<asp:Label ID="Label1" runat="server" Text=""></asp:Label>,<br />
&nbsp;лифты/застревание-<asp:Label ID="Label2" runat="server" Text=""></asp:Label>,<br />
&nbsp;лифты/останов-<asp:Label ID="Label3" runat="server" Text=""></asp:Label>,
            <br />
&nbsp;лифты/внеплановые работы-<asp:Label ID="Label4" runat="server" Text=""></asp:Label>,<br />
&nbsp;остальное -<asp:Label ID="Label5" runat="server" Text=""></asp:Label>,
            ВСЕГО:-<asp:Label ID="Label6" runat="server" Text=""></asp:Label>
         <br />       
         <br /> 
    <div id="dvHtml" runat="server">
     
    <asp:PlaceHolder ID="Period" runat="server"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Выбирете период отчета по превышению нормативного времени:<br /><br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;С <uc:DatePicker ID="Beg" runat="server" />
        <span style="padding-left:15px;">по</span> <uc:DatePicker ID="End" runat="server" /> <br /><br /> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Вид услуги:<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnTextChanged="Uslugy_TextChanged"></asp:DropDownList>
        Вид работ:<asp:DropDownList ID="DropDownList2" runat="server"></asp:DropDownList>
      ...
      <h4><asp:PlaceHolder ID="phReport" runat="server">         
            ...
            <LayoutTemplate>
                <table border="1" id="tblr" runat="server" cellpadding="3">
                    <tr id="Tr2" runat="server" style="background-color: #85b9f8; color:#000;">
                        ...
                        <td id="td15" runat="server" class="td5px">адрес</td>
        ...
        <div class="content-wrapper">
                <div class="float-left">
                  <p> &copy; <%: DateTime.Now.Year %>- КОС</p></div><br /><br />
