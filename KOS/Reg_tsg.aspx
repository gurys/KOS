<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Reg_tsg.aspx.cs" Inherits="KOS.Reg_tsg" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Активные События</title>
    <style type="text/css">
...
<body>
    <form id="form1" runat="server" style ="background-color:#ede8e8; font-family:'Segoe UI', Verdana, Helvetica, Sans-Serif; font-size: 13px;">
        <body onload="startTime()"><div id="txt" class="float-right"></div></body>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/logo.png" PostBackUrl="~/" />
                    <br />
        <br />
            ...
            <LayoutTemplate>
                <table id="tblr" runat="server" cellpadding="3">
                    <tr id="Tr2" runat="server" style="background-color: #336699; color:#FFF;">
                        <td id="td5" runat="server" class="td5px">№</td>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:PlaceHolder ID="ButtonReg" runat ="server">
    <asp:Button runat="server"  Width="212px" Text="РЕГИСТРАЦИЯ СОБЫТИЙ" OnClick="DiagrammODS_Click" BackColor="#CC0000" ForeColor="White" Height="65px"/>&nbsp;</asp:PlaceHolder><br />
       <asp:ScriptManager runat="server">
        ...
        <div class="content-wrapper">
                <div class="float-left">
                  <p> &copy; <%: DateTime.Now.Year %>- КОС</p></div><br /><br /></div></form></body></html>