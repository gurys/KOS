<%@ Page Title="Запрос Менеджеру" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ZaprosMng.aspx.cs" Inherits="KOS.ZaprosMng" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server"> 
    <h4>События с запросом Менеджеру:</h4>
   <br />
  <table>
      <tr>
        <td rowspan="2">
