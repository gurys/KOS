...
namespace KOS
{
    public partial class RegNZ_tsg : System.Web.UI.Page  
    {
        ...
        void UpdateLabel()
        {
            ...
            {
                case 0:
                    What.Text = "Активные события";
                    break;
                case 1:
                    What.Text = "Не назначенные события на " + DateTime.Now.Date.ToShortDateString();
                    break;
        ...
        List<Data> GetData()
        {
            ...
            if (User.Identity.Name == "ODS14") url = "~/ZakTSG.aspx?zId=";
            ...
            using (SqlConnection conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["DefaultConnection"].ToString()))
            {
                ...
                string s = "select Id, EventId, RegistrId, DataId, ZayavId, WZayavId, Sourse, Family, IO, " +
                    "TypeId, LiftId, Who, ToApp, DateWho, DateToApp, Comment, Prim from Events " +
                    "where Cansel=N'false' and Family=@user and ToApp=N' '";
        ...
        protected void InSmsText_Click(object sender, EventArgs e)
        {
            ...
            catch { Response.Redirect("~/RegNZ_tsg.aspx"); }
        ...
        string CheckAccount()
        {
            ...
            List<string> roles = new List<string>() { "ODS_tsg", "Cadry" };
        ...
        {
            Response.Redirect("~/ZakrytieTSG.aspx");
        }
