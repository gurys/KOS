<%@ Page Title="Назначение заявки" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ZayavkaEditODS.aspx.cs" Inherits="KOS.ZayavkaEditODS" %>
                ...
                <table id="tblr" runat="server" cellpadding="2">
                    <tr id="Tr2" runat="server" style="background-color: #808080; color:#FFF;">
                     ...
                     <tr id="Tr1" runat="server" style="background-color: #FFF; color:#000;">
                        ...
                        <td id="td11" runat="server" class="td5px"><asp:Literal ID="Lift" runat="server"></asp:Literal></td>
                        <td id="td12" runat="server" class="td5px"><asp:Literal ID="Address" runat="server"></asp:Literal></td>
                        <td id="td13" runat="server" class="td5px"><asp:Literal ID="Category" runat="server"></asp:Literal></td>
                        <td id="td14" runat="server" class="td5px"><asp:Literal ID="Disp" runat="server"></asp:Literal></td>
                        <td id="td15" runat="server" class="td5px"><asp:Literal ID="From" runat="server"></asp:Literal></td>
                        <td id="td16" runat="server" class="td5px"><asp:Literal ID="Prinyal" runat="server"></asp:Literal></td>
                        <td id="td17" runat="server" class="td5px"><asp:Literal ID="Start" runat="server"></asp:Literal></td>
                        <td id="td18" runat="server" class="td5px"><asp:Literal ID="StartPrinyal" runat="server"></asp:Literal></td>
                        <td id="td19" runat="server" class="td5px"><asp:Literal ID="Status" runat="server"></asp:Literal></td>
                        <td id="td20" runat="server" class="td5px"><asp:Literal ID="Prostoy" runat="server"></asp:Literal></td>
                    </tr>
                    </table>
            

&nbsp;Описание события:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Выбор механика: <asp:DropDownList ID="Worker" runat="server"></asp:DropDownList>
    <br />
    <asp:TextBox ID="Text" runat="server" Height="46px" Width="586px" TextMode="MultiLine" Columns="50" Rows="5" ReadOnly="true" OnTextChanged="Text_TextChanged"></asp:TextBox>

    <asp:Button ID="Save" runat="server" Text="Назначить" OnClick="Save_Click" />
</asp:Content>
