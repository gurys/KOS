...
namespace KOS
{
    public partial class PrimTSG : System.Web.UI.Page
    {
        ...
        void UpdateLabel()
        {
            ...
            {
                case 0:
                    What.Text = "Активные события с замечаниями";
        ...
        List<Data> GetData()
        {
            ...
            using (SqlConnection conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["DefaultConnection"].ToString()))
            {
                ...
                string s = "select e.Id, e.EventId, e.RegistrId, e.DataId, e.ZayavId, e.WZayavId, e.Sourse, e.Family, e.IO, " +
                    "e.TypeId, e.LiftId, e.Who, e.ToApp, e.DateWho, e.DateToApp, e.Comment, e.Prim from Events e ";
                if (_type == 0) // архив
                {
                    s += "where e.[Cansel]=N'false' and e.[Prim]!=N' ' and e.Family=@user";                   
