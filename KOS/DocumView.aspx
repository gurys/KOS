<%@ Page Title="Скачать/Просмотреть документ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumView.aspx.cs" Inherits="KOS.DocumView" %>
      ...
      <table id="tblr" runat="server">
                    <tr id="Tr2" runat="server" style="background-color: #9face9; color:#000;">
                     ...
                     <tr id="Tr1" runat="server" style="background-color: #FFF; color:#000;">
                        ...
                        <td id="td18" runat="server" class="td5px"><asp:Literal ID="Prim1" runat="server"></asp:Literal></td>                        
